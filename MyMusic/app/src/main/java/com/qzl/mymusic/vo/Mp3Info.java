...
public class Mp3Info {
    ...
    public String toString() {
        return "Mp3Info [id=" + id + ", mp3InfoId=" + mp3InfoId + ", playTime="
                + playTime + ", isLike=" + isLike + ", title=" + title
                + ", artist=" + artist + ", album=" + album + ", albumId="
                + albumId + ", duration=" + duration + ", size=" + size
                + ", url=" + url + ", isMusic=" + isMusic + "]";
    }
